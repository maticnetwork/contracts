...
class Deployer {
  ...
  async freshDeploy(options = {}) {
    ...
    await this.mapToken(this.maticWeth.address, this.maticWeth.address, false /* isERC721 */)
    await this.mapToken(this.rootERC721.address, this.rootERC721.address, true /* isERC721 */)
