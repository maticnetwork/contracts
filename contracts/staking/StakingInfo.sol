...
contract StakingInfo {
    ...
    event Released(uint256 indexed validatorId, address indexed signer);
    ...
    function logReleased(uint256 validatorId, address signer)
        public
        onlyStakeManager
    {
        emit Released(validatorId, signer);
    }
