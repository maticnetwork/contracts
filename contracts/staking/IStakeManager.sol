...
contract IStakeManager {
  ...
  function checkSignatures(uint256 blockInterval, bytes32 voteHash, bytes32 stateRoot, bytes32 delegationAccRoot, bytes32 delegationWithdrawRoot, bytes memory sigs) public returns(uint256);
